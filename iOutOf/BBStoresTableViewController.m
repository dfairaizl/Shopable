...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    BBStore *selectedStore = (BBStore *)sender;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    BBStore *currentStore = (BBStore *)[self.frc objectAtIndexPath:indexPath];
    
    cell.textLabel.text = currentStore.name;
...
{
    BBStore *selectedStore = (BBStore *)[self.frc objectAtIndexPath:indexPath];
    
    [self performSegueWithIdentifier:@"StoreSelectionSegue" sender:selectedStore];
}
